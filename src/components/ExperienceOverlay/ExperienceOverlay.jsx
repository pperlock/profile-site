...
function ExperienceOverlay() {
    ...
    const events=[
        {id:'996c7cd9', date: "Feb - May 2021", type: "professional", background:"/icons/brainstation3.png", place: "BrainStation", position:"Teaching Assistant", summary: "teaching stuff",
            summary: "Reading and debugging code of other developers, guiding students to adhere to industry-standard best practices to produce premium styling and functionality for their web applications, teaching students to learn to solve problems using logical thinking."},
        {id:'996c7ca8', date: "Oct 2020 - Feb 2021", type: "education", background:"/icons/brainstation3.png", place: "BrainStation", position: "Web Development Diploma", summary:"learning stuff",
            summary: "Full-Stack Development.  Experience using provided mockups in pdf and Figma format to create respnsive applications using a mobile first approach with HTML and SASS.  Created interactive sites using both React and js DOM manipulation that pulled from APIs to serve dynamic content from outside sources.  Built Resful APIs using Node.js and express to serve up database information from MongoDB.  Dabbled in cloud storage with Firebase and passport authentication."},
        ...
        {id:'996c7a6e', date: "2010-2015", type: "professional", background:"/icons/dogs-north.png", place: "Dog's North", position: "Owner, Lead Trainer",
            summary: "Orchestrated a validation program on an unstandardized, undocumented database to increase the accuracy of data used for making profitable business decisions."},
