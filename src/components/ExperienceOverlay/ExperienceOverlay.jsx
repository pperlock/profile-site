        ...
        <div>
            <div className="education"> 
                ...
                <div className="education__list">
                    <ul className="education__list-item ">
                        <li className="education__list-title"> Web Development </li>
                        <div className="education__list__place">
                            <img className="education__list__place-image" src="/icons/brainstation3.png"/>
                    ...
                    <ul className="education__list-item">
                        ...
                        <div className="education__list__place">
                            <img className="education__list__place-image" src="/icons/uwo.png"/>
            ...
            <div className="education"> 
                ...
                <div className="education__list">
                    <ul className="education__list-item ">
                        ...
                        <div className="education__list__place">
                            <img className="education__list__place-image" src="/icons/klg.png"/>
                    ...
                    <ul className="education__list-item ">
                        ...
                        <div className="education__list__place">
                            <img className="education__list__place-image" src="/icons/sas.png"/>
