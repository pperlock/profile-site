...
function AboutOverlay({showOverlay}) {
    return (
        ...
        <div className="about__overlay"> 
            <h2 className={showOverlay ? "about__overlay-title animate" : "about__overlay-title"}>Who is She?</h2>
            <div className="about__overlay-who">
                ...
                I proudly embrace my diverse background and the lessons I have learned because of it.  My path may seem disjointed to some, but it has created the <span className="about__overlay-text--emphasize">intriguing, multi-talented, well-rounded individual </span> I am today.</p>
            ...
            <h2 className={showOverlay ? "about__overlay-title animate" : "about__overlay-title"}>What Can You Expect From Her?</h2>
            ...
            At the same time, <span className="about__overlay-text--emphasize">I play well with others </span> in a collaborative team environment where I can take the reigns and <span className="about__overlay-text--emphasize">lead</span> or pull back and have another person lead the way.  
            My process from start to finish is very <span className="about__overlay-text--emphasize">detailed-oriented</span> and <span className="about__overlay-text--emphasize">quality driven </span> with a focus on edge cases affecting <span className="about__overlay-text--emphasize">user experience</span>.  
