        ...
        <>
            ...
            <main>
                <aside className = {reachedBottom ? "main__contacts main__contacts--bottom" : "main__contacts"}>
                    <a href="https://github.com/pperlock" target="_blank" rel="noopener noreferrer"><img className={reachedBottom ? "main__contacts-icon main__contacts-icon--bottom-first" : "main__contacts-icon"} src="/icons/github-icon.svg" alt="github" /></a>
                    <a href="https://www.linkedin.com/in/pattiperlock" target="_blank" rel="noopener noreferrer"><img className={reachedBottom ? "main__contacts-icon main__contacts-icon--bottom-second" : "main__contacts-icon"} src="/icons/linkedin-icon.svg" alt="linked in" /></a>
                    ...
                    <a href="/files/patti-perlock-resume-revised.pdf" target="_blank" rel="noopener noreferrer"><img className={reachedBottom ? "main__contacts-icon main__contacts-icon--bottom-fourth" : "main__contacts-icon"} src="/icons/resume-icon.svg" alt="resume"/></a>
                </aside>
