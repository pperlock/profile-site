    ...
    return (
        <>
            ...
            <div className = "contact__links">
                <Sparkles><a href="https://github.com/pperlock" target="_blank" rel="noopener noreferrer">
                <img className="contact__links-icon" src="/icons/github-icon.svg" alt="github" data-aos-anchor=".contact" data-aos="zoom-in-right" data-aos-delay="200" data-aos-offset="500" data-aos-duration="500"/>
                </a></Sparkles>
